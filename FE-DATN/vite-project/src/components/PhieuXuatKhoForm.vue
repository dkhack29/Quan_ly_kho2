        ...
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center space-x-4">
            ...
            >
              ...
              <span>{{ showForm ? 'Ẩn Form' : 'Tạo Phiếu Xuất' }}</span>
            </button>
            <button
              @click="scanCode"
      ...
      <div v-if="showForm" class="mb-8">
        <div class="bg-white rounded-2xl shadow-xl border-0 overflow-hidden">
          <div class="bg-white border-b border-gray-200 px-8 py-6">
            ...
            <p class="text-gray-600 mt-1">Điền đầy đủ thông tin để tạo phiếu xuất kho mới</p>
          </div>
          ...
          <form @submit.prevent="handleSubmit" class="p-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div class="space-y-6">
                ...
                <div class="space-y-2">
                  <label class="block text-sm font-medium text-gray-700">
                    Giá xuất <span class="text-red-500">*</span>
                  </label>
                  <div class="relative">
                    <input
            ...
            <div class="flex items-center space-x-4">
              <div class="relative">
                <input
                  ...
                  class="w-80 px-4 py-3 pl-10 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200"
                />
              ...
              <select
                v-model="sortBy"
                class="px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200"
              >
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
              <div class="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm font-medium">
                {{ filteredItems.length }} phiếu xuất
              </div>
            </div>
          </div>
        </div>
          ...
          <table class="w-full">
            <thead class="bg-gray-50">
              <tr>
                ...
                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" @click="sort('nguonXuat')">
                  Nguồn xuất
                  <svg class="w-4 h-4 inline ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"/>
                  </svg>
                ...
                <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" @click="sort('giaXuat')">
                  Giá xuất
                  <svg class="w-4 h-4 inline ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"/>
                  </svg>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="item in paginatedItems" :key="item.maPhieu" class="hover:bg-gray-50 transition-colors duration-200">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm font-medium text-gray-900">{{ item.nguonXuat }}</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-900">{{ formatCurrency(item.giaXuat) }}</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
...
console.log('PhieuXuatKhoForm component loaded')
...
const items = ref([
  {
    ...
    thoiGian: '2025-01-15T14:30:00'
  },
  {
    maPhieu: 'PX002',
    nguonXuat: 'Chuyển kho',
    tenHang: 'iPhone 15 Pro',
    soLuong: 3,
    giaXuat: 32000000,
    tinhTrang: 'Chờ duyệt',
    tenNguoiTao: 'Trần Thị B',
    thoiGian: '2025-01-14T16:20:00'
  },
  {
    maPhieu: 'PX003',
    nguonXuat: 'Bán hàng',
...
const filteredItems = computed(() => {
  ...
  if (searchQuery.value) {
    ...
    filtered = filtered.filter(item =>
      ...
      item.nguonXuat.toLowerCase().includes(query) ||
...
// Methods
const handleSubmit = () => {
  if (!formData.value.maPhieu || !formData.value.tenHang || !formData.value.soLuong || !formData.value.giaXuat) {
