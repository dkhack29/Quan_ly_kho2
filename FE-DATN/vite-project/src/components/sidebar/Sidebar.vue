    ...
    >
      ...
      <nav class="py-2">
        <ul class="space-y-2 font-medium">
          ...
          <li><button @click="() => { emit('switch-view', 'phieu-xuat-kho'); hideDrawer() }" class="w-full text-left flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-700 hover:bg-gray-100 dark:hover:bg-slate-400">Phiếu Xuất Kho</button></li>
